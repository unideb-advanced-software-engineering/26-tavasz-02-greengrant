...
# 3.	External Interface Requirements
  ...
  -	Web interface
    ...
    -	contains different views for each role
    -	integrated AI tool
  ...
  -	the notification system implements and is dependent on the MundaMail™ API.
...
# 4.	System Features
  ...
  ##### F-LG-01
  The system supports fuzzy search over grant names and descriptions.    
  
  ##### F-LG-02
  The system provides a filtering option based on the following parameters: 
  -   start date
  -   end date
  ...
  The user provides the required documentation and information for the application, and the system validates the submission and, if valid, records the application by storing all of its information and documents.

  ### 4.2.3	Functional Requirements
  ##### F-AG-01
  The system is able to accept text and file input through a form.
  ##### F-AG-02
  The system is able to validate all forms of input based on size, content, metadata, and others.
  ##### F-AG-03
  ...
  Provides a notification feature for the status of applications through the use of MundaMail.
  ...
  ##### F-MM-02
  The system is able to send a templated message through MundaMail triggered by a detected change, with the correct values.
  ...
  Provides the ability to publish grants in the system.
  ...
  ##### F-CG-01
  The system is able to accept the provided information. 
  ##### F-CG-02
  ...
  ## 4.8 Manage the web applications
...
# 5.	Other Nonfunctional Requirements
  ...
  The processing process consists of client-side input validation and crucial data transfer to the server. The files and other forms of high-volume data are transferred and stored asynchronously.
